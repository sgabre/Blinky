...
#define iPIT_CHANNEL_0 0U                     /**< 0 */
#define iPIT_CHANNEL_1 0x1U                   /**< 1 */
#define iPIT_CHANNEL_2 0x2U                   /**< 2 */
#define iPIT_CHANNEL_3 0x3U                   /**< 3 */

/* Module clock constants */
#define iPIT_CLOCK_ENABLED  0U                /**< Enabled */
#define iPIT_CLOCK_DISABLED PIT_MCR_MDIS_MASK /**< Disabled */

/* Freeze constants */
#define iPIT_TIMERS_RUN     0U                /**< Run */
#define iPIT_TIMERS_STOPPED PIT_MCR_FRZ_MASK  /**< Stopped */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = iPIT_GetInterruptMask(<peripheral>_BASE_PTR,
 *      iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_GetInterruptMask(PeripheralBase, ChannelIdx) ( \
 ...
 * @par Example:
 *      @code
 *      uint32_t result = iPIT_GetInterruptFlag(<peripheral>_BASE_PTR,
 *      iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_GetInterruptFlag(PeripheralBase, ChannelIdx) ( \
 ...
 * @par Example:
 *      @code
 *      iPIT_EnableInterrupt(<peripheral>_BASE_PTR, iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_EnableInterrupt(PeripheralBase, ChannelIdx) ( \
 ...
 * @par Example:
 *      @code
 *      iPIT_DisableInterrupt(<peripheral>_BASE_PTR, iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_DisableInterrupt(PeripheralBase, ChannelIdx) ( \
    PIT_TCTRL_REG(PeripheralBase,(ChannelIdx)) &= \
 ...
 * @par Example:
 *      @code
 *      iPIT_ClearInterruptFlag(<peripheral>_BASE_PTR, iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_ClearInterruptFlag(PeripheralBase, ChannelIdx) ( \
 ...
 * @par Example:
 *      @code
 *      iPIT_ModuleClock(<peripheral>_BASE_PTR, iPIT_CLOCK_ENABLED);
 *      @endcode
 */
#define iPIT_ModuleClock(PeripheralBase, Clock) ( \
 ...
 * @par Example:
 *      @code
 *      iPIT_ModuleFreeze(<peripheral>_BASE_PTR, iPIT_TIMERS_RUN);
 *      @endcode
 */
#define iPIT_ModuleFreeze(PeripheralBase, Freeze) ( \
    PIT_MCR_REG(PeripheralBase) = \
     (uint32_t)(( \
 ...
 * @par Example:
 *      @code
 *      iPIT_WriteLoadReg(<peripheral>_BASE_PTR, iPIT_CHANNEL_0, 1);
 *      @endcode
 */
#define iPIT_WriteLoadReg(PeripheralBase, ChannelIdx, Value) ( \
 ...
 * @par Example:
 *      @code
 *      uint32_t result = iPIT_ReadLoadReg(<peripheral>_BASE_PTR,
 *      iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_ReadLoadReg(PeripheralBase, ChannelIdx) ( \
    PIT_LDVAL_REG(PeripheralBase,(ChannelIdx)) \
  )
 ...
 * @par Example:
 *      @code
 *      uint32_t result = iPIT_ReadTimerValueReg(<peripheral>_BASE_PTR,
 *      iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_ReadTimerValueReg(PeripheralBase, ChannelIdx) ( \
 ...
 * @par Example:
 *      @code
 *      iPIT_EnableDevice(<peripheral>_BASE_PTR, iPIT_CHANNEL_0,
 *      PDD_DISABLE);
 *      @endcode
 */
#define iPIT_EnableDevice(PeripheralBase, ChannelIdx, State) ( \
    PIT_TCTRL_REG(PeripheralBase,(ChannelIdx)) = \
     (uint32_t)(( \
      (uint32_t)(( \
       PIT_TCTRL_REG(PeripheralBase,(ChannelIdx))) & ( \
 ...
 * @par Example:
 *      @code
 *      uint32_t result = iPIT_GetEnableDeviceStatus(<peripheral>_BASE_PTR,
 *      iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_GetEnableDeviceStatus(PeripheralBase, ChannelIdx) ( \
 ...
 * @par Example:
 *      @code
 *      iPIT_WriteModuleControlReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
#define iPIT_WriteModuleControlReg(PeripheralBase, Value) ( \
    PIT_MCR_REG(PeripheralBase) = \
     (uint32_t)(Value) \
  )
 ...
 * @par Example:
 *      @code
 *      uint32_t result = iPIT_ReadModuleControlReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
#define iPIT_ReadModuleControlReg(PeripheralBase) ( \
    PIT_MCR_REG(PeripheralBase) \
  )
 ...
 * @par Example:
 *      @code
 *      iPIT_WriteTimerControlReg(<peripheral>_BASE_PTR, iPIT_CHANNEL_0,
 *      1);
 *      @endcode
 */
#define iPIT_WriteTimerControlReg(PeripheralBase, ChannelIdx, Value) ( \
    PIT_TCTRL_REG(PeripheralBase,(ChannelIdx)) = \
     (uint32_t)(Value) \
  )
 ...
 * @par Example:
 *      @code
 *      uint32_t result = iPIT_ReadTimerControlReg(<peripheral>_BASE_PTR,
 *      iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_ReadTimerControlReg(PeripheralBase, ChannelIdx) ( \
    PIT_TCTRL_REG(PeripheralBase,(ChannelIdx)) \
  )
 ...
 * @par Example:
 *      @code
 *      iPIT_WriteTimerFlagReg(<peripheral>_BASE_PTR, iPIT_CHANNEL_0, 1);
 *      @endcode
 */
#define iPIT_WriteTimerFlagReg(PeripheralBase, ChannelIdx, Value) ( \
    PIT_TFLG_REG(PeripheralBase,(ChannelIdx)) = \
     (uint32_t)(Value) \
  )
 ...
 * @par Example:
 *      @code
 *      uint32_t result = iPIT_ReadTimerFlagReg(<peripheral>_BASE_PTR,
 *      iPIT_CHANNEL_0);
 *      @endcode
 */
#define iPIT_ReadTimerFlagReg(PeripheralBase, ChannelIdx) ( \
    PIT_TFLG_REG(PeripheralBase,(ChannelIdx)) \
  )
#endif  /* #if defined(iPIT_H_) */
